    ...
    def __getitem__(self, idx):
        try:
            ...
            with h5py.File(self.file_path, "r") as file:
                # Load input features
                input_phase = file["input_features_phase"][idx]
                input_spectrogram = file["input_features_spectrogram"][idx]
                input_edges = file["input_features_edges"][idx]
                input_mfcc = file["input_features_mfccs"][idx]
                input_mfcc_delta = file["input_features_mfcc_delta"][idx]
                input_mfcc_delta2 = file["input_features_mfcc_delta2"][idx]

                # Load target
                target_spectrogram = file["target_features_spectrogram"][idx]
